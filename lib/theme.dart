...
class MaterialTheme {
  ...
  static ColorScheme lightScheme() {
    return const ColorScheme(
      ...
      onPrimaryFixedVariant: Color(4279126643),
  ...
  static ColorScheme lightMediumContrastScheme() {
    return const ColorScheme(
      ...
      surfaceTint: Color(4281295500),
      onPrimary: Color(4294967295),
      primaryContainer: Color(4282939812),
      ...
      onTertiary: Color(4294967295),
      tertiaryContainer: Color(4286541457),
  ...
  static ColorScheme darkScheme() {
    return const ColorScheme(
      ...
      primaryContainer: Color(4279126643),
  ...
  static ColorScheme darkMediumContrastScheme() {
    return const ColorScheme(
      ...
      scrim: Color(4278190080),
      inverseSurface: Color(4292928232),
      inversePrimary: Color(4279257972),
      primaryFixed: Color(4291749375),
      ...
      tertiaryFixedDim: Color(4292067302),
      onTertiaryFixedVariant: Color(4282265679),
      surfaceDim: Color(4279243800),
      surfaceBright: Color(4281743678),
      surfaceContainerLowest: Color(4278914834),
      surfaceContainerLow: Color(4279770144),
  ...
  static ColorScheme darkHighContrastScheme() {
    return const ColorScheme(
      ...
      primaryContainer: Color(4288663551),
      onPrimaryContainer: Color(4278190080),
      ...
      primaryFixedDim: Color(4288663551),
      ...
      onTertiaryFixedVariant: Color(4280094765),
      surfaceDim: Color(4279243800),
      surfaceBright: Color(4281743678),
      surfaceContainerLowest: Color(4278914834),
      surfaceContainerLow: Color(4279770144),
